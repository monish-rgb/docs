...
- [Prompt owners](#prompt-owners) for controlling who can tag commits and delete a prompt.
...
![Commits tab](/langsmith/images/commits-tab.png) ![Create new prompt tag](/langsmith/images/create-new-prompt-tag.png)
...
![Move prompt tag](/langsmith/images/move-prompt-tag.png)
...
The prompt owners feature gives you fine-grained control over who can tag commits and delete a specific prompt. This is useful for production promotion flows where you want to limit which team members can promote a commit to production by adding a tag.
...
- **Owners only**: only users added as prompt owners can create or update commit tags and delete the prompt.
